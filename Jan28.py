...
int1 = 10
float1 = 20.56
long1 = 289982904790009999999999999999999999999999
...
# CREATING LISTS AND TYPLES----------------------------

## in brief, list can be changed, tuples cannot
...
# CONVERTYING LISTS TO SERIES AND DATAFRAME
...
df3[['2',':)']][3:4] # get columms '2' and ':)' then
                        # get row 3
